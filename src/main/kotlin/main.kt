...
fun getMonthLimit(transferType: String): Int {
    return when (transferType) {
        "Maestro", "Mastercard", "Visa", "Мир" -> monthLimitCard
        "VK Pay" -> monthLimitVKPay
        else -> -1
    }
}
...
fun getMasterMaestroCommission(transferAmount: Int, monthAmount: Int = 0) : Int {
...
fun calculateCommission(transferType: String = "VK Pay", monthAmount: Int = 0, transferAmount: Int): Int {
    return when (transferType) {
